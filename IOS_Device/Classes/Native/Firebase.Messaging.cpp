...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR intptr_t FirebaseMessagingPINVOKE_Subscribe_m0A3E170E97D75A6E4F4800195F030D49AEC6FBA5 (String_t* ___jarg10, const RuntimeMethod* method);
	...
	{ // begin try (depth: 1)
		{
			...
			V_2 = (bool)((!(((RuntimeObject*)(EventHandler_1_t993C30857E350C8F4C6DE79548C9F54BE9BFA4CA *)L_3) <= ((RuntimeObject*)(RuntimeObject *)NULL)))? 1 : 0);
			...
			V_3 = (bool)((!(((RuntimeObject*)(EventHandler_1_tE00DA0138E91B1CCF1B26CCFC4EE6C41F8A0E0F4 *)L_4) <= ((RuntimeObject*)(RuntimeObject *)NULL)))? 1 : 0);
			bool L_5 = V_2;
			bool L_6 = V_3;
			V_4 = (bool)((int32_t)((int32_t)L_5|(int32_t)L_6));
			bool L_7 = V_4;
			if (!L_7)
			{
				goto IL_003d;
...
IL_0045:
		{
			...
			bool L_11 = V_2;
			bool L_12 = V_3;
			V_5 = (bool)((int32_t)((int32_t)L_11|(int32_t)L_12));
			bool L_13 = V_5;
			if (!L_13)
			{
				goto IL_005e;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR Task_t804B25CFE3FC13AAEE16C8FA3BF52513F2A8DB60 * FirebaseMessaging_SubscribeAsync_m9BD97C83C142D16D9AB72945FE5A9519E8003DE0 (String_t* ___topic0, const RuntimeMethod* method)
{
	static bool s_Il2CppMethodInitialized;
	if (!s_Il2CppMethodInitialized)
	{
	...
	Task_t804B25CFE3FC13AAEE16C8FA3BF52513F2A8DB60 * V_1 = NULL;
	{
		...
		IL2CPP_RUNTIME_CLASS_INIT(FirebaseMessagingPINVOKE_t63F9B29CBA853F9CA7FD0AC94E6204AD5F02A7C8_il2cpp_TypeInfo_var);
		intptr_t L_1;
		L_1 = FirebaseMessagingPINVOKE_Subscribe_m0A3E170E97D75A6E4F4800195F030D49AEC6FBA5(L_0, /*hidden argument*/NULL);
...
IL_0017:
	{
		Task_t804B25CFE3FC13AAEE16C8FA3BF52513F2A8DB60 * L_5 = V_1;
		return L_5;
	}
}
// System.Void Firebase.Messaging.FirebaseMessaging::SetListenerCallbacks(Firebase.Messaging.FirebaseMessaging/Listener/MessageReceivedDelegate,Firebase.Messaging.FirebaseMessaging/Listener/TokenReceivedDelegate)
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR Listener_tAB19365189BB8A64F1690C05B95B6EB8AD39F798 * Listener_Create_m50D7018148E3687E5A44CFC6E9D52CFED330E96C (const RuntimeMethod* method)
{
	...
	bool V_1 = false;
	bool V_2 = false;
	Listener_tAB19365189BB8A64F1690C05B95B6EB8AD39F798 * V_3 = NULL;
	Exception_t * __last_unhandled_exception = 0;
	...
	{ // begin try (depth: 1)
		{
			...
			V_2 = (bool)((!(((RuntimeObject*)(Listener_tAB19365189BB8A64F1690C05B95B6EB8AD39F798 *)L_3) <= ((RuntimeObject*)(RuntimeObject *)NULL)))? 1 : 0);
			bool L_4 = V_2;
			if (!L_4)
			{
				goto IL_002c;
...
IL_0049:
	{
		Listener_tAB19365189BB8A64F1690C05B95B6EB8AD39F798 * L_10 = V_3;
		return L_10;
	}
}
// System.Void Firebase.Messaging.FirebaseMessaging/Listener::Destroy()
	...
	{ // begin try (depth: 1)
		{
			...
			Monitor_Enter_mBEB6CC84184B46F26375EC3FC8921D16E48EA4C4(L_2, (bool*)(&V_1), /*hidden argument*/NULL);
			Listener_tAB19365189BB8A64F1690C05B95B6EB8AD39F798 * L_3 = ((Listener_tAB19365189BB8A64F1690C05B95B6EB8AD39F798_StaticFields*)il2cpp_codegen_static_fields_for(Listener_tAB19365189BB8A64F1690C05B95B6EB8AD39F798_il2cpp_TypeInfo_var))->get_listener_3();
			V_2 = (bool)((((RuntimeObject*)(Listener_tAB19365189BB8A64F1690C05B95B6EB8AD39F798 *)L_3) == ((RuntimeObject*)(Listener_tAB19365189BB8A64F1690C05B95B6EB8AD39F798 *)__this))? 1 : 0);
			bool L_4 = V_2;
			if (!L_4)
			{
				goto IL_003b;
